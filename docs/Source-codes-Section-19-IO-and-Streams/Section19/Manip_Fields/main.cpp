...
int main() {
  ...
  std::cout << "\n--width 10 for num1 and num2 and "
               "hello--------------------------------------"
            << std::endl;
  ruler();
  ...
  std::cout << "\n--width 10 for num1 and num2 and hello left for "
               "all---------------------------"
            << std::endl;
  ruler();
  ...
  std::cout << "\n--width 10 for num1 and num2 and hello left for all setfill "
               "to dash------------"
            << std::endl;
  ruler();
  std::cout << std::setw(10) << std::left << num1 << std::setw(10) << std::left
  ...
  std::cout << "\n--width 10 for num1 and num2 and hello - setfill "
               "varies------------------------"
            << std::endl;
  ruler();
